...
<body>
    <form method="POST" action="{{ route('comics.store') }}">
        ...
        <div>
            ...
            <input type="text" name="thumb" value="{{ old('thumb', '') }}" required maxlength="255">
            @error('thumb')
        ...
        <div>
            ...
            <input type="number" name="price" value="{{ old('price', '') }}" required max="999999.99">
            @error('price')
        ...
        <div>
            ...
            <input type="text" name="series" value="{{ old('series', '') }}" required maxlength="100">
            @error('series')
        ...
        <div>
            ...
            <input type="text" name="type" value="{{ old('type', '') }}" required maxlength="50">
            @error('type')
